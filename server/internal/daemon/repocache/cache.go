...
type WorktreeParams struct {
	...
	IssueIdentifier     string // human-readable issue key used in the branch name
...
func resolveBaseRefContext(ctx context.Context, barePath, requestedRef string) (string, error) {
	...
	// pr/N shorthand: fetch the pull request head from the remote. Kept from
	// our side of the merge; upstream has no PR-ref support.
